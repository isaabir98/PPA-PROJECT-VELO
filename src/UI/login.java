...
DatabaseConnection dbConnect = new DatabaseConnection();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/WhatsApp Image 2020-08-19 at 6.41.31 PM.jpeg"))); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/customer_48px.png"))); // NOI18N

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/broom_48px.png"))); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       try {
            ...
            if (email == true) {
                ...
                String query = "Select * from users Where eaddress='" + UserName + "'";
